...
/**
 * JR: Excellent job overall, demonstrates strong understanding of program concepts.
 * I like the creativity you applied:
 *  - User prompting (though as we discussed, this wouldn't normally be in a system class
 *    like Book, but fine for this assignment).
 *    We'll show proper MVC in the DuckRace application.
 *  - Logic involved in page turning and open/close book.
 *
 ...
 *
 * Class participation is very good, keep it up.
 *
...
public class Book {
    ...
    private String authorName;          // JR: author would suffice, vs. authorName
    private Integer totalNumOfPages;    // JR: totalPages probably a better name here
    private Integer currentPageNum = MIN_PAGES;  // JR: good use of MIN_PAGES, better name might be currentPage
    private Boolean isOpen = false;
    private Genre genre;

    // make this private, too   --fixed
    ...
    public void choiceOption() {
        ...
        do {
            menuOptions();
            optionChoice = String.valueOf(in.nextLine());   // change to nextLine() -fixed
