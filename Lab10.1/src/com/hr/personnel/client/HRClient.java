...
class HRClient {
    ...
    public static void main(String[] args) {
        ...
        try {
            dept.addEmployee(new HourlyEmployee("Logan", LocalDate.of(2002, 6, 2), 4.0, 40.0));
        } catch (IllegalWageException e) {
            // e.printStackTrace();
            // System.out.println("   ERROR: " + e);            // toString() called for concatenation
            System.out.println("ERROR: " + e.getMessage());     // just the "reason" string (message)
        }
