...
class ConcertTimeTest {
    ...
    public static void testLiveConcert() {
        ...
        ZoneId australia = ZoneId.of("Australia/Perth");

        ZonedDateTime torontoConcert = ZonedDateTime.of(
                LocalDateTime.of(2016, 2, 18, 19, 0),
                toronto);

        ZonedDateTime az = torontoConcert.withZoneSameInstant(australia);

        System.out.println("Time of the Concert in Australia" + az);
        System.out.println("Time of the Concert in Toronto"+ torontoConcert);
    }
}